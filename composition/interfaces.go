...
//go:generate mockgen -self_package composition -package composition -destination interface_mocks_test.go stash.rewe-digital.com/toom/lib-ui-service/composition Fragment,ContentLoader,Content,ContentMerger,ContentParser,ResponseProcessor
